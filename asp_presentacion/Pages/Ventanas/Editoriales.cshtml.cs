...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private IEditorialesPresentacion? iPresentacion = null;

        public EditorialesModel(IEditorialesPresentacion iPresentacion)
        {
            try
            {
                this.iPresentacion = iPresentacion;
                Filtro = new Editoriales();
            }
            catch (Exception ex)
            {
